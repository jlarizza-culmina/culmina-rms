...
export async function POST(request: NextRequest) {
  try {
    ...
    const { locationId, firstName, lastName, phone, partySize, email,
            birthdayMonth, birthdayDay, smsOptIn, emailOptIn, preferredLocationId,
            arrivalMode, estimatedArrivalAt } = body
    ...
    const msg = `Hi ${firstName}! You're ${ordinal(position)} in line at ${restaurantName} (${location.name}) — party of ${partySize}. We'll text you when your table is ready.`
